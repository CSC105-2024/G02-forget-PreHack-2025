...
const PagimationListForFilter = ({filterPosts, rating, categories, postsPerPage = 5}) => {
   // Current page start with 1
    ...
    const currentPosts = filterPosts.slice(start, start + postsPerPage);
...
export default PagimationListForFilter