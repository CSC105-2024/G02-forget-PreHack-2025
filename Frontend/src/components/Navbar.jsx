    ...
    <header className=''>
        <nav className='flex justify-between items-center max-sm:h-15 h-25 w-screen bg-white drop-shadow-[0_2px_5px_rgba(0,0,0,0.25)]'>
            ...
            <NavLink className='flex items-center max-sm:ml-2 max-sm:mr-2 ml-5 mr-5'>
                <input type="text" placeholder='Type your food' className='border-1 border-[#D9D9D9] max-sm:rounded-[50px] max-sm:h-[30px] rounded-2xl py-2 px-3 max-sm:w-[200px] w-150 max-sm:text-[15px] text-[20px] hover:border-black'/>
                <FaSearch className='text-[15px] lg:text-[24px] -ml-10 cursor-pointer'/>
            </NavLink>
            <NavLink to={"/login"} className='flex items-center gap-3 border-1 border-[#D9D9D9] max-sm:ml-7 py-1 px-1 lg:py-2 lg:px-6 rounded-2xl mr-10 hover:border-black cursor-pointer'>
