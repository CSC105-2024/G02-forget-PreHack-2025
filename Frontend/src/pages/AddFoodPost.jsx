  ...
  return (
    ...
    <form action="">
            ...
            <div className='bg-white w-275 max-sm:w-100 p-5 rounded-lg drop-shadow-[0_4px_3px_rgba(0,0,0,0.25)]'>
                ...
                <div className='ml-20'>
                    <label>
                        ...
                        <input type="text" value={food} onChange={(e) => setFood(e.target.value)} required className='border-1 border-[#D9D9D9] p-2 text-[18px] rounded-lg w-150 mb-5 hover:border-black max-sm:-ml-18 max-sm:w-85 max-sm:mb-10' placeholder='Type your food name'/>
                    </label>
                    <label>
                        ...
                        {categoryList.map((category, index) => (
                            <div key={index}>
                                <select value={category} onChange={(e) => handleChangeCategory(index, e.target.value)} required className='border-1 border-[#D9D9D9] p-2 text-[18px] rounded-lg w-150 mb-5 hover:border-black max-sm:-ml-18 max-sm:w-85'>
                                    <option value=""></option>
                    ...
                    <label>
                        ...
                        <div className='flex gap-3'>
                            <input type="number" value={price} onChange={(e) => setPrice(e.target.value)} required className='border-1 border-[#D9D9D9] p-2 text-[18px] rounded-lg w-150 mb-5 hover:border-black max-sm:-ml-18' placeholder='Type your food price'/>
            ...
            <div className='bg-white w-275 max-sm:w-100 p-5 rounded-lg drop-shadow-[0_4px_3px_rgba(0,0,0,0.25)]'>
                ...
                <div className='ml-20'>
                    <label>
                        ...
                        <input type="text" value={location} onChange={(e) => setLocation(e.target.value)} required className='border-1 border-[#D9D9D9] p-2 text-[18px] rounded-lg w-150 mb-5 hover:border-black max-sm:-ml-18 max-sm:w-85' placeholder='Type your food location'/>
                    </label>
                </div>
            </div>
        </div>
        <div className='flex flex-col items-center justify-center my-10'>
            ...
            <button type='submit' onClick={submitPost} className='bg-[#DE0000] text-white text-[20px] font-semibold ml-250 mt-10 px-6 py-2 rounded-lg cursor-pointer max-sm:ml-65'>Confirm</button>
        </div>
    </form>
    </>
  )
