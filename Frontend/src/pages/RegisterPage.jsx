            ...
            <div className=''>
                <form action="">
                    ...
                    <div className='flex items-center'>
                        <input type="Password" placeholder='Enter your Password' className='text-[18px] border-1 border-[#D9D9D9] rounded-lg px-3 py-1 mt-2 w-100 max-sm:ml-2 hover:border-black max-sm:w-85'/>
